...
## Table Of Contents
1. [Introduction](#introduction-table-of-contents-scroll-up-toc)
2. [Features](#features-table-of-contents-scroll-up-toc)
3. [Importing](#importing-table-of-contents-scroll-up-toc)
    1. [Requirements](#requirements-table-of-contents-scroll-up-toc)
    2. [Location](#location-table-of-contents-scroll-up-toc)
    3. [An example import](#an-example-import-table-of-contents-scroll-up-toc)
4. [Basic Usage](#basic-usage-table-of-contents-scroll-up-toc)
    1. [A simple download for one table](#a-simple-download-for-one-table-table-of-contents-scroll-up-toc)
    2. [Multiple Tables](#multiple-tables-table-of-contents-scroll-up-toc)
5. [Configurations for initialization](#configurations-for-initialization-table-of-contents-scroll-up-toc)
    1. [Example](#example-table-of-contents-scroll-up-toc)
6. [Configurations for each table/sheet](#configurations-for-each-tablesheet-table-of-contents-scroll-up-toc)
    1. [Customize Worksheet Tabs](#customize-worksheet-tabs-table-of-contents-scroll-up-toc)
    2. [Exclude certain Rows or Columns](#exclude-certain-rows-or-columns-table-of-contents-scroll-up-toc)
    3. [Default Column Widths](#default-column-widths-table-of-contents-scroll-up-toc)
    4. [Custom Column Widths](#custom-column-widths-table-of-contents-scroll-up-toc)
    5. [Wrap Text](#wrap-text-table-of-contents-scroll-up-toc)
    6. [Run functions before and after operations for each table](#run-functions-before-and-after-operations-for-each-table-table-of-contents-scroll-up-toc)
    7. [Console Log for debugging](#console-log-for-debugging-table-of-contents-scroll-up-toc)
7. [Future Scope](#future-scope-table-of-contents-scroll-up-toc)
8. [Versions](#versions-table-of-contents-scroll-up-toc)
